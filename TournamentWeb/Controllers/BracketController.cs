...
namespace TournamentWeb.Controllers
{
    public class BracketController : Controller
    {
        ...
        public BracketController(TournamentWebContext context, UserManager<AppUser> userMgr)
        {
            _context = context;
            userManager = userMgr;
        }
        ...
        public IActionResult Index(int id, string User)
        {
            ViewBag.id = id;
            ViewBag.User = User;
            return View();
        ...
        public async Task<ActionResult> UpdateTeams(int? id1, string jsonstring)
        {
            ...
            return Json("http://" + "localhost:44881/Bracket/Index/" + id1 + "?User=" + userManager.GetUserId(User));
        }
