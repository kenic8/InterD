#pragma checksum "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "520ff47440d61314a570b51c59e915c32a07476d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"520ff47440d61314a570b51c59e915c32a07476d", @"/Views/Bracket/Index.cshtml")]
    ...
    public class Views_Bracket_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
...
#nullable restore
#line 17 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
                   Write(ViewBag.User);
    ...
    if ($('#Tcontainer').length) {
        $(""#Tcontainer"").ready(function () {
            $.ajax({
                url: """);
#nullable restore
#line 82 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
...
#nullable disable
            WriteLiteral("\",\r\n                type: \'POST\',\r\n                data: {\r\n                    \'id1\': ");
#nullable restore
#line 85 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
                      Write(ViewBag.id);
...
#nullable disable
    ...
    function drawStuff(players) {
        ...
        for (let i = 0; i < bracketTemplate[`Temp${players}`].length; i++) {
            ...
            bottom: ${bracketTemplate[`Temp${p");
            WriteLiteral(@"layers}`][i].y}px;
            "">
        ...
        //le");
            WriteLiteral(@"t scrolltopos = ($(""#Tcontainer"").width() / 2)
    ...
    function GeneratePlacements(players) {
        for (let u = 0; u < TeamsArray.length; u++) {
            ...
            if (MatchPattern[TeamsArray[u].matchWins] == MatchPattern[MatchPattern.length - 1]) {
                document.getElementById(`M${Teams.player1.Index}`).classList.add(""Winn");
            WriteLiteral(@"er"")
            }
    ...
    function GetContestants(PlayerOneIndex, players) {
        ...
        for (let u = 0; u < TeamsArray.length; u++) {
         ...
         ");
            WriteLiteral(@"       for (let i = 0; i < TeamsArray.length; i++) {
    ...
    document.getElementById(""Tcontainer"").addEventListener(""click"", function (e) {
        if (Tournament.userId == userIDString) {
            if (e.target.classList.contains(""ActiveP"")) {
                console.log(""yes"", e.target.classList.co");
            WriteLiteral(@"ntains(""ActiveP""))
    ...
    function UpdateBrackets() {
        console.log(""yes"")
            $.ajax({
                url: """);
#nullable restore
#line 239 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
...
#nullable disable
            WriteLiteral("\",\r\n                type: \'POST\',\r\n                data: {\r\n                    \'id1\': ");
#nullable restore
#line 242 "C:\Users\lille\Desktop\New Repo\InterD\TournamentWeb\Views\Bracket\Index.cshtml"
                      Write(ViewBag.id);
...
*/
    ...
    .player {
        background-image: url(""/image");
            WriteLiteral(@"s/assets/brackets/standard_container.jpg"");
